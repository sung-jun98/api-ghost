...
public class ResponseBranch {
    ...
    public static class Builder {
        ...
        public Builder when(WhenCondition when) { this.when = when; return this; }
        public Builder then(ThenAction then) { this.then = then; return this; }
     ...
     * Getter
     */
    public WhenCondition getWhen() { return when; }
    public ThenAction getThen() { return then; }
}
