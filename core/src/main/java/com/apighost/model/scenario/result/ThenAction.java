...
/**
 * Defines the action to take when a branch condition is met.
 * This may include saving variables and specifying the next scenario step.
 *
 * @author haazz
 * @version BETA-0.0.1
 */
public class ThenAction {
    ...
    public static class Builder {
        ...
        public Builder save(Map<String, Object> save) { this.save = save; return this; }
     ...
     * Getter
     */
    public Map<String, Object> getSave() { return save; }
