...
public class YamlLoadTestParameterWriterTest {
    ...
    /**
     * 1. The YAML file is created successfully.
     * 2. The content of the file matches the expected values from the original
     *    LoadTestParameter object.
     *
    ...
    void YamlLoardTestParamWriterTest() throws IOException {
        ...
        writer.writeLoadTestParameter(loadTestParameter, TEST_FILE_PATH);
